...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function optimize()
    {
        ...
        foreach ($files as $id => $item) {
            $encodedPath = $item['f'];
            $decodedPath = $this->utf8Decode($encodedPath);
    ...
    public function scanAndReindexPath($path)
    {
        ...
        foreach ($iterator as $file) {
            if ($file->isFile()
                ...
                $encodedPath = $this->utf8Encode($filePath);
    ...
    public function getUtil($type, $filePath)
    {
        ...
        return str_replace('%filepath%', $escapedFilepath, $cmd);
    }
    ...
    /**
     * The utf8_decode substitute.
     *
     * @param string $str
     * @return string
     */
    public function utf8Decode($str)
    {
        if (function_exists('mb_convert_encoding')
            ...
            $str = iconv('UTF-8', 'ISO-8859-1', $string);
        }
