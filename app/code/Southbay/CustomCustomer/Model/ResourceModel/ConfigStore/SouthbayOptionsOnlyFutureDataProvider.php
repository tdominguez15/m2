...
class SouthbayOptionsOnlyFutureDataProvider implements OptionSourceInterface
{
    ...
    public function toOptionArray()
    {
        if (!isset($this->_options)) {
            ...
            $collection->addFieldToFilter(\Southbay\CustomCustomer\Api\Data\ConfigStoreInterface::SOUTHBAY_FUNCTION_CODE, ConfigStoreInterface::FUNCTION_CODE_FUTURES);
