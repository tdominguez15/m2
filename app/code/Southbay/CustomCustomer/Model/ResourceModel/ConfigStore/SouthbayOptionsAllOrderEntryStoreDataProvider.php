...
class SouthbayOptionsAllOrderEntryStoreDataProvider implements OptionSourceInterface
{
    ...
    public function toOptionArray()
    {
        if (!isset($this->_options)) {
            ...
            $collection->addFieldToFilter(\Southbay\CustomCustomer\Api\Data\ConfigStoreInterface::SOUTHBAY_FUNCTION_CODE, ['in' => [ConfigStoreInterface::FUNCTION_CODE_FUTURES, ConfigStoreInterface::FUNCTION_CODE_AT_ONCE]]);
