...
namespace Southbay\CustomCustomer\Model\ResourceModel\SoldTo\Backend;

use Southbay\CustomCustomer\Model\ResourceModel\SoldTo\CollectionFactory as CollectionFactory;


class SoldToDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        foreach ($items as $item) {
            $id = $item->getId();
            $url = $url_builder->getUrl('southbay_custom_customer/soldto/edit', ['id' => $id]);
