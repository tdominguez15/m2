...
class Dataprovider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function __construct($name,
        ...
        $requestFieldName,
                                ...
                                \Southbay\CustomCustomer\Model\ResourceModel\OrderEntryRepConfig\CollectionFactory $collection_factory,
    ...
    public function getData()
    {
        ...
        if ($id) {
            ...
            foreach ($items as $item) {
                $data = $item->toArray();
                $data['can_approve_at_once'] = $data['can_approve_at_once'] ? __('Yes') : __('No');
