        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                $item[$this->getData('name')] = [
                    'edit' => [
                        'href' => $this->backendUrl->getUrl('southbay_custom_customer/orderentrynotification/edit', ['id' => $item['entity_id']]),
                        'label' => __('Editar')
                    ],
                    'remove' => [
                        'href' => $this->backendUrl->getUrl('southbay_custom_customer/orderentrynotification/delete', ['id' => $item['entity_id']]),
                        'label' => __('Eliminar')
                    ]
                ];
            }
