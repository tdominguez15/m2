...
namespace Southbay\CustomCustomer\Model\ResourceModel\CustomerConfig\Backend;

use Southbay\CustomCustomer\Model\ResourceModel\CustomerConfig\CollectionFactory as CollectionFactory;


class CustomerConfigDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        foreach ($items as $item) {
            $id = $item->getId();
            $url = $url_builder->getUrl('southbay_custom_customer/config/edit', ['id' => $id]);
