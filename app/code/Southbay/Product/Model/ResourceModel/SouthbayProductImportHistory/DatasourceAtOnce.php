...
class DatasourceAtOnce extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function __construct($name,
        ...
        $requestFieldName,
                                ...
                                \Southbay\Product\Model\ResourceModel\SouthbayProductImportHistory\CollectionFactory $collection_factory,
    ...
    public function getCollection()
    {
        if (is_null($this->collection)) {
            ...
            $this->collection->addFieldToFilter('is_at_once', ['eq' => true]);
            $this->collection->addFieldToFilter('type', ['eq' => SouthbayProductImportHistoryInterface::TYPE_IMPORT]);
        }
