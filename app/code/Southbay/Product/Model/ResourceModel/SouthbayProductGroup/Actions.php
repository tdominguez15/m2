        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                $item[$this->getData('name')] = [
                    'edit' => [
                        'href' => $this->backendUrl->getUrl('southbay_order_entry/productgroup/edit', ['id' => $item['entity_id']]),
                        'label' => __('Editar')
                    ],
                    'remove' => [
                        'href' => $this->backendUrl->getUrl('southbay_order_entry/productgroup/delete', ['id' => $item['entity_id']]),
                        'label' => __('Eliminar')
                    ]
                ];
            }
