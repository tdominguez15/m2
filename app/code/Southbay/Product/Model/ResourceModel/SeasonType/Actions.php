        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                $item[$this->getData('name')] = [
                    'edit' => [
                        'href' => $this->backendUrl->getUrl('southbay_order_entry/seasontype/edit', ['id' => $item['type_id']]),
                        'label' => __('Editar')
                    ],
                    'remove' => [
                        'href' => $this->backendUrl->getUrl('southbay_order_entry/seasontype/delete', ['id' => $item['type_id']]),
                        'label' => __('Eliminar')
                    ]
                ];
            }
