        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                $item[$this->getData('name')] = [
                    'edit' => [
                        'href' => $this->backendUrl->getUrl('southbay_order_entry/segmentation/edit', ['id' => $item['entity_id']]),
                        'label' => __('Editar')
                    ],
                    'remove' => [
                        'href' => $this->backendUrl->getUrl('southbay_order_entry/segmentation/delete', ['id' => $item['entity_id']]),
                        'label' => __('Eliminar')
                    ]
                ];
            }
