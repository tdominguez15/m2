...
namespace Southbay\ReturnProduct\Block\Adminhtml\ReasonReject\Grid;
...
class Grid extends GridBaseBlock
{
    ...
    {
        $this->addColumn(
            \Southbay\ReturnProduct\Api\Data\SouthbayReasonReject::ENTITY_COUNTRY_CODE,
            [
                'header' => __('País'),
                'type' => 'text',
                'index' => \Southbay\ReturnProduct\Api\Data\SouthbayReasonReject::ENTITY_COUNTRY_CODE,
        ...
        $this->addColumn(
            \Southbay\ReturnProduct\Api\Data\SouthbayReasonReject::ENTITY_CODE,
            [
                'header' => __('Código'),
                'type' => 'text',
                'index' => \Southbay\ReturnProduct\Api\Data\SouthbayReasonReject::ENTITY_CODE,
                'sortable' => true,
                'filter' => false
            ]
        );
        ...
        $this->addColumn(
            \Southbay\ReturnProduct\Api\Data\SouthbayReasonReject::ENTITY_NAME,
            [
                'header' => __('Nombre'),
                'type' => 'text',
                'index' => \Southbay\ReturnProduct\Api\Data\SouthbayReasonReject::ENTITY_NAME,
                'sortable' => true,
                'filter' => false
            ]
        );
