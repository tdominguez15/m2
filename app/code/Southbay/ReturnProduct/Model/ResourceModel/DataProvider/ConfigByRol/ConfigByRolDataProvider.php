...
namespace Southbay\ReturnProduct\Model\ResourceModel\DataProvider\ConfigByRol;
...
class ConfigByRolDataProvider extends \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        foreach ($items as $item) {
            $id = $item->getId();
            $url = $url_builder->getUrl('southbay_return_product/configbyrol/view', ['id' => $id]);
