...
use Southbay\ReturnProduct\Api\Data\SouthbayConfigNotificationRtvByRol as EntityInterface;

class SouthbayConfigNotificationRtvByRol extends \Magento\Framework\Model\AbstractModel implements EntityInterface
{
    ...
    {
        $this->_init('Southbay\ReturnProduct\Model\ResourceModel\SouthbayConfigNotificationRtvByRol');
    }
