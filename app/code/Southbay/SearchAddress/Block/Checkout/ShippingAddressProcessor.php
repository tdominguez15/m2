...
namespace Southbay\SearchAddress\Block\Checkout;

use Magento\Checkout\Block\Checkout\LayoutProcessorInterface;
use Magento\Framework\UrlInterface;
use Southbay\SearchAddress\Model\Config;
...
class ShippingAddressProcessor implements LayoutProcessorInterface
{
    ...
    private function getLayoutConfig(array $addressOptions, int $customerId, int $numberOfAddresses): array
    {
        return [
            ...
            'children' => [
                'addressDefault' => [
                    'component' => 'Southbay_SearchAddress/js/view/shipping-address/selected',
                ...
                'selectShippingAddressModal' => [
                    ...
                    'children' => [
                        'searchShippingAddress' => [
                            ...
                            'component' => 'Southbay_SearchAddress/js/view/shipping-address/ui-select',
                            'template' => 'Southbay_SearchAddress/ui-select',
                            'disableLabel' => true,
                            'filterOptions' => true,
                            'searchOptions' => true,
                            'chipsEnabled' => true,
